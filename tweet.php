    ...
    <div class="col-sm-12 mt-3">
        ...
        <div class="">
            ...
            <div class="status mt-1">
                <input type="text" hidden id="user_id_like" value="<?php echo $rowPosting['id_user'] ?>">
                <button class="btn ms-5 me-5" onclick="toggleLike(<?php echo $rowPosting['id']; ?>)"><svg
                        xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="red"
                        stroke="gray" stroke-width="1.5">
                        <path
                            d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                    </svg> <?php echo isset($rowLike['countuser']) ? $rowLike['countuser'] : 0 ?></button>
            </div>
            <!-- button komen -->
            <div class="flex-grow-1 ms-3 mt-4">
                ...
                <div class="mt-3">
                    ...
                    <p class="mb-3 mt-2 ms-4" style="font-size: 18px"><?php echo $rowCount['comment_text'] ?>
                    </p>
                    <?php
                            }
                        } ?>
    ...
    fetch("like_status.php", {
        ...
        .then(data => {
            if (data.status === "liked") {
                ...
                alert("Are you sure you wanna unliked this?");
            }
            location.reload();
        })
